...
```bash
git clone git@github.com:FWAPP-UniUD/hello-world-<michelagrasselli>.git
````

The precise git repository can be obtained from the “Clone or download” green button in the github page.

This command will create a directory named `hello-world-<michelagrasselli>` in the same directory on which you are issuing your command.
...
Inside the `hello-world-<michelagrasselli>` directory (`cd` there if needed), you can issue the command:
...
If everything went good, now at `https://github.com/FWAPP-UniUD/hello-world-<michelagrasselli>` you should see the `README.md` file updated with the new content.
